...
export default {
  ...
  expire_on_close: process.env.SESSION_EXPIRE_ON_CLOSE === 'true' === 'true',
  encrypt: process.env.SESSION_ENCRYPT === 'true' === 'true',
  ...
  http_only: process.env.SESSION_HTTP_ONLY !== 'false' !== 'false',
