...
export default {
  ...
  connections: {
    sqlite: {
      ...
      database: process.env.DB_DATABASE ?? path.resolve(__dirname, '..', 'database', 'database.sqlite'),
      prefix: '',
    ...
    mysql: {
      ...
      strict: true,
      engine: null,
      options: process.env.MYSQL_ATTR_SSL_CA ? { ssl: { ca: process.env.MYSQL_ATTR_SSL_CA } } : undefined,
    },
    mariadb: {
      driver: 'mariadb',
      url: process.env.DB_URL,
