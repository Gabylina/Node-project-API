...
const tasks = MEM.tasks; // Needed for cascade delete in destroy

// Helper to get route parameters for project
...
export async function update(req, res, next) {
  try {
    ...
    // projects[projectIndex] = project; // Not strictly needed as project is a reference, but good for clarity
