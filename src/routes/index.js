...
// Placeholder for authentication middleware (Laravel's auth:sanctum)
...
// --- Laravel's Route::prefix('auth')->group(...) equivalent ---
// Unprotected Auth routes
router.post('/auth/register', AuthController.register);
router.post('/auth/login', AuthController.login);

// Apply authentication middleware specifically for /auth routes defined after this point
// This mimics Laravel's 'auth:sanctum' for routes inside 'prefix(auth)' group
...
// --- Laravel's Route::middleware('auth:sanctum')->group(...) equivalent ---
// Apply authentication middleware for all subsequent routes
router.use(requireAuth);

// Projects routes (Laravel's apiResource equivalent)
